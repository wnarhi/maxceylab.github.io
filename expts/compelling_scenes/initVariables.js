...
let StudyTrialType = [];
StudyTrialType = StudyTrialType.concat(repmat(repmat([0, 1], RpPlusExem.length/2), RpCats.length), repmat(repmat(2, NrpExem.length), NrpCats.length/2)); // half as many study trials
