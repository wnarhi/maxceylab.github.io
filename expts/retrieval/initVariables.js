...
// let RandStart = Math.floor(Math.random()*360)+1; // random number from 1 to 360
...
let RpPlusRC = wrap(counter(1,360,360/RpPlusR.length).map(function(entry) {  return entry+(Math.floor(Math.random()*360)+1); }));
let RpPlusPracR = [];
...
let RpMinusRC = wrap(counter(1,360,360/RpMinusR.length).map(function(entry) {  return entry+(Math.floor(Math.random()*360)+1); }));
let NrpR = chance1.shuffle(perm_concat(NrpCatsR,NrpExemR));
let NrpRC = wrap(counter(1,360,360/NrpR.length).map(function(entry) {  return entry+(Math.floor(Math.random()*360)+1); }));
let PracLuresR = chance1.shuffle(perm_concat(RpCatsR,PracLuresExemR));
let PracLuresRC = wrap(counter(1,360,360/PracLuresR.length).map(function(entry) {  return entry+(Math.floor(Math.random()*360)+1); }));
let RpTestLuresR = chance1.shuffle(perm_concat(RpCatsR,RpTestLuresExemR));
let RpTestLuresRC = wrap(counter(1,360,360/RpTestLuresR.length).map(function(entry) {  return entry+(Math.floor(Math.random()*360)+1); }));
let NrpTestLuresR = chance1.shuffle(perm_concat(NrpCatsR,NrpTestLuresExemR));
let NrpTestLuresRC = wrap(counter(1,360,360/NrpTestLuresR.length).map(function(entry) {  return entry+(Math.floor(Math.random()*360)+1); }));
