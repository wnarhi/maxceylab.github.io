clc; clear;
cwd = '/Users/scotti.5/Documents/GitHub/maxceylab.github.io/stimuli/letters/letter_examples';
imagefiles = dir(fullfile(cwd, ('*.png')));
nfiles = length(imagefiles);    % Number of files found

cd output

preset = ['<img id="IDN" src="https://maxceylab.github.io/stimuli/letters/Object.png" style="margin-left:-1000px">'];
code = [];
for i = 1:nfiles
    presetNew = strrep(preset,'Object',['Letter_',num2str(10+i)]);
    presetNew = strrep(presetNew,'IDN',['Letter_',num2str(10+i)]);
