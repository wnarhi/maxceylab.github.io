clc; clear;
cwd = '/Users/scotti.5/Documents/GitHub/maxceylab.github.io/stimuli/objects';
imagefiles = dir(fullfile(cwd, ('Obj*.png')));
nfiles = length(imagefiles);    % Number of files found

% cd output

preset = ['<img id="IDN" src="https://maxceylab.github.io/stimuli/objects/Object.png" style="margin-left:-1000px;margin-top:-2000px">'];
code = [];
for i = 1:nfiles
